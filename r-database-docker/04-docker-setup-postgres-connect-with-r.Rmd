...
The purpose of this exercise is to illustrate the creation of a new temporary `cattle` database.  If it already exists, it is forcibly removed from the container in the next code block.
...
```{r}
mtcars_df <- dbGetQuery(con,"SELECT * FROM mtcars")
