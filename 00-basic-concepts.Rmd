...
You run R from RStudio to set up Docker, run postgreSQL inside it and then send queries directly to postgreSQL from R. (We provide more details about our sandbox environment in the chapter on [mapping your environment](#chapter_appendix-sandbox-environment).

## Tidy data

Tidy is practical. getting tidy. 

Normalization.

Efficiency: for storage and retrieval on the databse side vs for analysis

## Tidiverse and the pipe operator
...
## PostgresSQL concepts includes connection parameters (intro)
