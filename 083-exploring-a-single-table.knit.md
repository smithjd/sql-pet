...
The trend is positive on average 1.828707e+04 but half of the months have swings greater than 1.898840e+06!
...
#qbupehfsrx .gt_sep_right {
  border-right: 5px solid #FFFFFF;
}

#qbupehfsrx .gt_group_heading {
  padding: 8px;
  /* row_group.padding */
  color: #333333;
  background-color: #FFFFFF;
...
#qbupehfsrx .gt_empty_group_heading {
  padding: 0.5px;
  color: #333333;
  background-color: #FFFFFF;
  /* row_group.background.color */
...
#qbupehfsrx .gt_striped {
  background-color: #8080800D;
  /* row.striping.background_color */
}

#qbupehfsrx .gt_from_md > :first-child {
  margin-top: 0;
}

#qbupehfsrx .gt_from_md > :last-child {
  margin-bottom: 0;
}
...
#qbupehfsrx .gt_first_summary_row {
  padding-top: 8px;
  /* summary_row.padding */
  padding-bottom: 8px;
  /* summary_row.padding */
...
#qbupehfsrx .gt_grand_summary_row {
  color: #333333;
  background-color: #FFFFFF;
...
#qbupehfsrx .gt_first_grand_summary_row {
  padding-top: 8px;
  /* grand_summary_row.padding */
  padding-bottom: 8px;
  /* grand_summary_row.padding */
...
#qbupehfsrx .gt_font_normal {
  font-weight: normal;
}

#qbupehfsrx .gt_font_bold {
  font-weight: bold;
}

#qbupehfsrx .gt_font_italic {
  font-style: italic;
}
...
#qbupehfsrx .gt_footnote_marks {
  font-style: italic;
  font-size: 65%;
}
</style>
<div id="qbupehfsrx" style="overflow-x:auto;overflow-y:auto;width:auto;height:auto;"><table class="gt_table">
