...
In this chapter we touched on a number of functions from the DBI Package.  The table in `96a` shows a list of functions in the package.  The Chapter column references a section in the book if we have used it.
