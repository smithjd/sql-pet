...
```{r, dplyr inner join Details, eval=FALSE}
...
```{r Dplyr left outer join Details, eval=FALSE}
...
```{r Dplyr left outer join Details with c/s store_id, eval=FALSE}
...
```{r Dplyr Right outer join Details, eval=FALSE}
...
```{r Dplyr Full Join Details, eval=FALSE}
