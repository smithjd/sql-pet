...
```{r  }
dbGetQuery(con,"select date(shipdate) - date(orderdate) ship_order_delta,date(duedate)-date(shipdate) due_ship_delta,count(*) 
...
dbGetQuery(con,"select sr.salesreasonid,sr.name,sr.reasontype,count(*),sum(subtotal) sales_dollars
           from sales.salesorderheader soh 
