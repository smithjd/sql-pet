...
2. In that file, all text files (scripts, program source, data, etc.) will need to have the designator `<spec> text eol=lf`, where `<spec>` is the file name specifier, for example, `*.sh`.
