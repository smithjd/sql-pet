...
```{r ex4-d, include=INCLUDE_OUTPUT, tidy=TRUE}
# sp_tbl_descr('table_name')
# sp_tbl_pk_fk('table_name')
# sp_print_df(table_rows_sql)
...
```{r ex5-d, include=INCLUDE_OUTPUT, tidy=TRUE}
# sp_tbl_descr('table_name')
# sp_tbl_pk_fk('table_name')
# sp_print_df(table_rows_sql)
...
```{r ex6-d, include=INCLUDE_OUTPUT, tidy=TRUE}
# sp_tbl_descr('table_name')
# sp_tbl_pk_fk('table_name')
# sp_print_df(table_rows_sql)
...
# dummy dplyr function passed to postgres to_char date function
# dt : date
...
#  The collect function is needed to use the dplyr format function.  Instead of using format we can
#  use the postgres function to_char.  This allows us to move the collect to the end.  
...
```{r ex27-s, code_folding='unhide', tidy=TRUE}
...
# drop table
if(db_has_table(con,'smy_test1')) {
  db_drop_table(con,'smy_test1')
}
# create database tabe
compute(smy_customer_details_dplyr,name='smy_test1',temporary = FALSE)
#collapse(x)
