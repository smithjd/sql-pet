...
```{r Calculate time period and annual sales dollars - 2 , fig.height=4, fig.width=5}
...
The trend is positive on average `r prettyNum(sum_lags[["Mean"]], big.mark = ",", format = "f", digits = 2)`. Let's calculate the inner quartile range to see how spread out our data is: `r prettyNum(sum_lags[["3rd Qu."]] - sum_lags[["1st Qu."]], big.mark = ",", format = "f", digits = 2)` This robust statistic shows us that we have a very large spread in our month-over-month. Next, let's visualize this variation. 
