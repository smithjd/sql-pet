...
months_to_inspect <- tibble(target_month = suspicious_months) %>%
  ...
  distinct()
```
We have `r nrow(months_to_inspect)` months when we add the month before and the month after the **suspicious months**.  We don't know whether the problem postings have been carried forward or backward.  We check for and eliminate duplicates as well.
