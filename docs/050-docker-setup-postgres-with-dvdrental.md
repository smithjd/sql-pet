...
## 1 4ed448c7… postgres-dv… latest <none>          About a… 2019-02-15 … 251MB
## 2 11160398… postgres     10     sha256:a0fdfd0… 21 hour… 2019-02-14 … 230MB
```
...
## 1 276884ed7553 post… docker… 2019-02-1… 1 seco… 0.0.… Up Le… 0B (… sql-…
...
##   container_id image command created_at created ports status size  names
##   <chr>        <chr> <chr>   <chr>      <chr>   <chr> <chr>  <chr> <chr>
## 1 276884ed7553 post… docker… 2019-02-1… 7 seco… <NA>  Exite… 0B (… sql-…
## # … with 3 more variables: labels <chr>, mounts <chr>, networks <chr>
```
...
##   container_id image command created_at created ports status size  names
##   <chr>        <chr> <chr>   <chr>      <chr>   <chr> <chr>  <chr> <chr>
## 1 276884ed7553 post… docker… 2019-02-1… 9 seco… 0.0.… Up Le… 63B … sql-…
## # … with 3 more variables: labels <chr>, mounts <chr>, networks <chr>
```
...
## 276884ed7553        postgres-dvdrental   "docker-entrypoint.s…"   9 seconds ago       Exited (0) Less than a second ago                       sql-pet
```
