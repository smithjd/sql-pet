...
## [2] "cf6978ebadd2        postgres-dvdrental   \"docker-entrypoint.s…\"   About a minute ago   Exited (0) 11 seconds ago                       sql-pet"
```
...
```
## [1] "73240427d5047866d38645ec1eef2c90dd464138b3610c491215246d8564fc76"
```
...
```
## [1] "CONTAINER ID        IMAGE               COMMAND                  CREATED             STATUS              PORTS                    NAMES"    
## [2] "73240427d504        postgres:10         \"docker-entrypoint.s…\"   4 seconds ago       Up 3 seconds        0.0.0.0:5432->5432/tcp   sql-pet"
```
...
```
## [1] "CONTAINER ID        IMAGE               COMMAND                  CREATED             STATUS                              PORTS               NAMES"    
## [2] "73240427d504        postgres:10         \"docker-entrypoint.s…\"   15 seconds ago      Exited (0) Less than a second ago                       sql-pet"
```
