...
## baf4571ff902        postgres-dvdrental   "docker-entrypoint.s…"   About a minute ago   Exited (0) 5 seconds ago                       sql-pet
```
...
```
## [1] "a2fb81d37368af9f372e6ad51a52dc079fa1a5a5b0a28e2c1c2bc8a732e67394"
```
...
```
## CONTAINER ID        IMAGE               COMMAND                  CREATED             STATUS              PORTS                    NAMES
## a2fb81d37368        postgres:10         "docker-entrypoint.s…"   3 seconds ago       Up 3 seconds        0.0.0.0:5432->5432/tcp   sql-pet
```
...
```
## CONTAINER ID        IMAGE               COMMAND                  CREATED             STATUS                              PORTS               NAMES
## a2fb81d37368        postgres:10         "docker-entrypoint.s…"   14 seconds ago      Exited (0) Less than a second ago                       sql-pet
```
