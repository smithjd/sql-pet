...
## [2] "48efcbd16156        postgres-dvdrental   \"docker-entrypoint.s…\"   About a minute ago   Exited (0) 5 seconds ago                       sql-pet"
```
...
```
## [1] "64e02f3c731a6a96ff8b32ea406cc5af1ec89efcd49564a52f4d0663d297b7c8"
```
...
```
## [1] "CONTAINER ID        IMAGE               COMMAND                  CREATED             STATUS              PORTS                    NAMES"    
## [2] "64e02f3c731a        postgres:10         \"docker-entrypoint.s…\"   3 seconds ago       Up 3 seconds        0.0.0.0:5432->5432/tcp   sql-pet"
```
...
```
## [1] "CONTAINER ID        IMAGE               COMMAND                  CREATED             STATUS                              PORTS               NAMES"    
## [2] "64e02f3c731a        postgres:10         \"docker-entrypoint.s…\"   14 seconds ago      Exited (0) Less than a second ago                       sql-pet"
```
