...
```
## Sending build context to Docker daemon  48.15MB
...
```
## [1] "181327375ea1f97daea12df363c09bc7745a1fa7673f392a0d015a683b8e60c0"
```
...
## 181327375ea1        postgres-dvdrental   "docker-entrypoint.s…"   7 seconds ago       Exited (0) Less than a second ago                       sql-pet
```
