...
```
## [1] "5a35bd1cd1185efd7ca4da9403c63c769fa1305c19e36d3be93ff9f35657bfaa"
```
...
## 5a35bd1cd118        postgres-dvdrental   "docker-entrypoint.s…"   10 seconds ago      Exited (0) Less than a second ago                       sql-pet
