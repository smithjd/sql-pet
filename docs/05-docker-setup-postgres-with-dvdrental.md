...
```
##  [1] "Sending build context to Docker daemon  26.95MB\r\r"                                                                                                                                                                                                                                                                                                                                           
...
```
## [1] "docker: Error response from daemon: Conflict. The container name \"/sql-pet\" is already in use by container \"908bc8e8abdd99af4384dc7ddf5adbb433beda9c12394a3b53683dc124102b3a\". You have to remove (or rename) that container to be able to reuse that name."
...
## [2] "908bc8e8abdd        postgres-dvdrental   \"docker-entrypoint.s…\"   14 minutes ago      Exited (0) Less than a second ago                       sql-pet"
```
