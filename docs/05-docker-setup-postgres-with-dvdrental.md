...
```
##  [1] "Sending build context to Docker daemon  3.109MB\r\r"                                                                                                                                                                                                                                                                                                                                           
...
```
## [1] "c60f1b9676119e14fdd539419ed4e3cfc637cd2f90f39366435b3818e34e49ce"
```
...
```
## [1] "c60f1b967611        postgres-dvdrental   \"docker-entrypoint.s…\"   20 seconds ago      Exited (137) Less than a second ago                       sql-pet"
```
