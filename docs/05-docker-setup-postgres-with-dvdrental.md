...
```
##  [1] "Sending build context to Docker daemon  22.42MB\r\r"                                                                                                                                                                                                                                                                                                                                           
...
```
## [1] "fea37155e41540e7fa7a86f63351667b40544f7c63b5473b87f1421d00d690ac"
```
...
## [2] "fea37155e415        postgres-dvdrental   \"docker-entrypoint.s…\"   7 seconds ago       Exited (0) Less than a second ago                       sql-pet"
```
