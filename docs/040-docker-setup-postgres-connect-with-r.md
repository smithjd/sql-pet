...
## [3] "49bd152b5402        postgres:10         \"docker-entrypoint.s…\"   Less than a second ago   Up Less than a second   0.0.0.0:5432->5432/tcp   cattle"
```
...
## 1 49bd152b5402 post… docker… 2019-02-2… 1 seco… 0.0.… Up Le… 0B (… catt…
