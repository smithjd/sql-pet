...
This is complicated when R interacts with SQL.  In a [vignette for dbplyr](https://cran.r-project.org/web/packages/dbplyr/vignettes/dbplyr.html) Hadley Wikham explains:
...
> [`Q %>% as_tibble()`](#Q-as-tibble) | ![](screenshots/green-check.png)![](screenshots/green-check.png) Forces `Q` to be a tibble
...
More examples of lazy execution can be found [here](https://datacarpentry.org/R-ecology-lesson/05-r-and-databases.html).
